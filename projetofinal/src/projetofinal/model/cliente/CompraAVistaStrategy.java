...
public class CompraAVistaStrategy implements MotoCompraStrategy{
...
public void comprarMoto() {
    try (Connection conn = ConnectionFactory.getConnection()) {
       System.out.print("Digite o modelo da moto para compra a vista: ");
        ...
        while (rs.next()) {
			...
			System.out.println("Moto da marca: " + marca + " e modelo: " + modelo + " comprada por: " + preço + " a vista.");
		}
	}catch (Exception e) {
		e.printStackTrace();
}
